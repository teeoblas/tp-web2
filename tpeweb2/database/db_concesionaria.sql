...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2025 a las 11:57:53
...
--
ALTER TABLE `marca`
  ADD CONSTRAINT `marca_ibfk_1` FOREIGN KEY (`id_marca`) REFERENCES `vehiculos` (`id_marca`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
